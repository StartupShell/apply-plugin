...
include_once('StartupShellApplyCustomizations_OptionsManager.php');

class StartupShellApplyCustomizations_InstallIndicator extends StartupShellApplyCustomizations_OptionsManager {
